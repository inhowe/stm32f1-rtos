...
void  BSP_LED_On (CPU_INT08U led)
{
    switch (led) {
        case 0:
             GPIO_SetBits(GPIOB, BSP_GPIOC_LED1 | BSP_GPIOC_LED2 | BSP_GPIOC_LED3 | BSP_GPIOC_LED4);
             break;
        ...
        case 3:
             GPIO_SetBits(GPIOB, BSP_GPIOC_LED3);
             break;

        case 4:
             GPIO_SetBits(GPIOB, BSP_GPIOC_LED4);
             break;
...
void  BSP_LED_Off (CPU_INT08U led)
{
    switch (led) {
        case 0:
             GPIO_ResetBits(GPIOB, BSP_GPIOC_LED1 | BSP_GPIOC_LED2 | BSP_GPIOC_LED3 | BSP_GPIOC_LED4);
             break;
        ...
        case 3:
             GPIO_ResetBits(GPIOB, BSP_GPIOC_LED3);
             break;

        case 4:
             GPIO_ResetBits(GPIOB, BSP_GPIOC_LED4);
             break;
